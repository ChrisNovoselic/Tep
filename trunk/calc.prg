...
'.064*(inm(getIndexOfIInM("55"),n_blokov+1)-14.5)*(100-inm(getIndexOfIInM("59"),i))/100'                 &&71 dq 4 (Ар)
...
DO ALTERC WITH getIndexOfIOutM("71"),5,'.075*(inm(getIndexOfIInM("55"),n_blokov+1)-14.5)'                 &&71 dq 4 (Ар)
DO ALTERC WITH getIndexOfIOutM("71"),6,'.085*(inm(getIndexOfIInM("55"),n_blokov+1)-14.5)'                 &&71 dq 4 (Ар)
...
'.041*(inm(getIndexOfIInM("54"),n_blokov+1)-13.0)*(100-inm(getIndexOfIInM("59"),i))/100'                 &&92 dЭ тд (Wp)
DO ALTERC WITH getIndexOfIOutM("92"),5,'.04*(inm(getIndexOfIInM("54"),n_blokov+1)-13.0)'                  &&92 dЭ тд (Wp)
DO ALTERC WITH getIndexOfIOutM("92"),6,'.04*(inm(getIndexOfIInM("54"),n_blokov+1)-13.0)'                  &&92 dЭ тд (Wp)
...
***
*DO ALTERC WITH getIndexOfIOutM("96"),3,'F2(oum(getIndexOfIOutM("65"),i),0,"2.26:1(3)")'                       &&96 Э пп (исх)
*DO ALTERC WITH getIndexOfIOutM("96"),4,'F2(oum(getIndexOfIOutM("65"),i),0,"2.26:1(3)")'                       &&96 Э пп (исх)
******
DO ALTERC WITH getIndexOfIOutM("96"),3,'F1(oum(getIndexOfIOutM("65"),i),"2.26:1(3)")'                       &&96 Э пп (исх)
DO ALTERC WITH getIndexOfIOutM("96"),4,'F1(oum(getIndexOfIOutM("65"),i),"2.26:1(3)")'                       &&96 Э пп (исх)
...
'.297*(inm(getIndexOfIInM("54"),n_blokov+1)-13.0)*(100-inm(getIndexOfIInM("59"),i))/100'                  &&97 dЭ пп (исх)
DO ALTERC WITH getIndexOfIOutM("97"),5,'.297*(inm(getIndexOfIInM("54"),n_blokov+1)-13.0)'                 &&97 dЭ пп (исх)
DO ALTERC WITH getIndexOfIOutM("97"),6,'.297*(inm(getIndexOfIInM("54"),n_blokov+1)-13.0)'                 &&97 dЭ пп (исх)
...
ELSE
	oum(getIndexOfIOutM("105a"),n_blokov+1)=F1(inm(getIndexOfIInM("43"),n_blokov+1),"2.51а:1") &&105a Э разм (н)	
ENDIF
